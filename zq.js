...
(function(window) {
	...
	zq.extend({
		...
		//图片上传插件
		imgUpload: function imgUpload(settings) {
			var defaultSetting = {
				obj: $(".imgUpload"),
				minSize: '',
				maxSize: '',
			...
			$.extend(defaultSetting, settings);
			var aa = '<div class="bg" onclick="zq.imghide()"></div><div class="imgShow" onclick="zq.imghide()"><span></span></div>' +
				'<div class="imgbox">' +
				'<div class="preview" onclick="zq.imgShow(event)"></div>' +
